...
\begin{tikzpicture}
  ...
  \node (2) at (15,-1){\includegraphics[scale=0.1]{chronogrames/19.jpeg}};
  \node (2) at (15,3){\includegraphics[scale=0.1]{chronogrames/17.jpeg}};
  \node (2) at (15,7){\includegraphics[scale=0.1]{chronogrames/18.jpeg}};
...
\end{tikzpicture}
  ...
  \begin{itemize}
  \item Switch 1: Scheduling all messages using decreasing the one with the longest route
  \item Switch 2: 
    \begin{enumerate}
    \item Send the first message able to be sent.
    \item After each sending,among the messages able to be sent.
    \item Send the one using the longest route.
    \end{enumerate}
...
Algorithms to find an optimal solution, if it exists in a given period.
\end{block}

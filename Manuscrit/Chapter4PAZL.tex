...
In this chapter, we show that for messages of arbitrary size, there is always a solution as soon as the load of the network is less than $40\%$. We propose several greedy algorithms and we give a canonical form of the assignments and an FPT algorithm using this form and solving \pma when the number of routes is low. Moreover, we explain how we can restrict our study to message of size $1$ without increasing too much the global latency. 

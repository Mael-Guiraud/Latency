...
\begin{itemize}
  ...
  Hence, if we fix $r_{O_i} \in S$, it will not change $ns(r_{O_1},r_{O_{i},c})$ and any extension of this compact assignment is dominated by the extension of the same compact assignment with $r_{O_i} \notin S$. Thus, we cut the branch $r_{O_i} \in S$ as in Figure~\ref{fig:cut1}.
  \begin{center}

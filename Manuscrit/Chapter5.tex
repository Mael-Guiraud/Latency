...
\hline
    ...
    \hline
 \end{tabular}
  \captionof{figure}{Average and largest number of steps needed by Tabu Search to reach a local optimum and average value of the margin of this local optimum. \label{tab:tabumemory}}
\end{center}
...
This chapter present a variant of the problems in previous chapters. Here, we consider the antennas sends their message at the same date, which correspond to the C-RAN context.
  We thus solve the synchronized version of the minimization problem \mintra related to \pall, called \minstra.  In \mintra, the objective was to reduce  local value of the transmission times of the route,

...
Also, it appears that, in most of $60\%$ of the cases, Tabu Search finds it's best assignment before $10$ steps, but some computation with $M > 200$ finds a better assignment up to the $150^{th}$ step. This means that running the Tabu Search longer could improve the quality of the result. 

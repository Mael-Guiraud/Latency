...
In this section, we compare the performance of all algorithms presented in this chapter.
 ...
 First, we study the case described in section~\ref{sec:generationrouted}. There is $8$ routes in the routed network, the length of the arcs are drawn between $0$ and $P$, and the load is $0.8$.

...
Figure~\ref{fig:stepsrecuit} shows the margin needed by simulated annealing with different values for $N$. Those results are computed on $1,000$ random instances, in which the initial temperature is set to $2200$ and the load is $80\%$
...
\subsection{Last contention depth}

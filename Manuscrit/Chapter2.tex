...
The algorithm we focus on in this thesis is described in~\cite{simons1978fast}. This paper propose a polynomial algorithm to solve the problem of scheduling a set of jobs of the same size minimizing the makespan. This is similar to our problem on a signle contention point, as in star shaped networks. Nevertheless, there is still the periodicity constraint to take into consideration. In this thesis, we propose several FPT algorithms based on this single processor scheduling algorithm.

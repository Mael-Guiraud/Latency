...
Such a mechanism leads us to determine the GCL in order to let the C-RAN flows cross the nodes at the exact time they arrive. \todo{phrase précédente pas claire}

...
is equivalent. It has already been defined as a useful subproblem in~\cite{barth2018deterministic} under the name BRA \todo{mettre le bon style}.
...
\hline
 ...
 the three algorithms almost always find the same assignment (or fail). On vertices of small load, the constraint of packing the datagram imposed by GD worsen the latency.

...
\todo{Mettre ca dans la partie experience, apres avoir décrit les instances sur lesquelles on travaille. En l'occurence, ici c'est plusieurs routes par flux, avec des flux biens répartis.}
\begin{center}
\begin{tabular}{ |c|c|c|c|c| }
\hline
    \backslashbox{Sucess}{Load} & $70\%$ & $80\%$& $90\%$& $100\%$ \\
    \hline
    GdA & $100\%$ & $95.1\%$& $56.3\%$& $11.2\%$ \\
 
    GdN & $99.9\%$ & $95.5\%$& $68.3\%$& $0\%$ \\

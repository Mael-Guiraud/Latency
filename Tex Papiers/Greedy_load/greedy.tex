...
message. Indeed, if we consider the operation which add one to all used elements
in the second periods is a bijection on the set of traces of size $n-1$, and it corresponds to removing one to the delay of the $n^{th}$ message. We assume that the delay is zero.
...
%Remarque si tous les delais sont différents, on peut les placer  

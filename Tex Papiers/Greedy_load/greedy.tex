...
on instances drawn uniformly at random. To this aim, we analyze the following algorithm, called \textbf{Uniform Greedy}: for each message in order, chose one possible offset
uniformly at random. We analyze the expectation that Uniform Greedy
solves the problem, averaged over all random choices \emph{and all possible instances}. 

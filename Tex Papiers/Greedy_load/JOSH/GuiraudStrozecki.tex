...
is still at the prototype phase~\cite{guiraud2022experimental} and has not been used in the field, thus no data exists on the typical delays that we should consider. However, from actual telecommunication protocols and technologies, we know that the value of $P$ is around $1000$ and the number of messages is from a few tens to a few hundreds at most~\cite{bartharxiv2018deterministic}. All experiments are done within this range.

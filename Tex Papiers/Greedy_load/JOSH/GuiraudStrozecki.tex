...
\end{center}
\caption{An example in which FO(A) = $(4 \tau -2)\lvert S\rvert$ in which $\lvert S\rvert = 1$ and there exists a $d_i = 0$. }
%\caption{An instance of \pma with $3$ messages, $P= 10$, $\tau = 2$, and one assignment}
\label{fig:FO}
\end{figure}

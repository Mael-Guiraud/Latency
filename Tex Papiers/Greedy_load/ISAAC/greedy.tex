...
The only algorithm, we have yet not described is Compact Fit. The idea is, as for Compact Pair, to combine 
the absence of conflict on the first period of Meta Offset and the compacity of the solution of First Fit.

...
then the same offset is forbidden \emph{twice} for a message of delay $d$. Hence, the potential of a message is related to the number of possible offsets as stated in the following lemma. Figure~\ref{fig:messagepotential} illustrate the computation of the potential of a message of delay $3$ in a partial assignment.
\begin{figure}
 \begin{center}
...
\begin{definition}
The potential of a position $i$, for a partial assignment $A$, is the number of messages of delay $d$ such that $i+d \mod P$ is used by a route scheduled by $A$ (Illustration in figure~\ref{fig:positionpotential}). 
\end{definition}
\begin{figure}
 \begin{center}

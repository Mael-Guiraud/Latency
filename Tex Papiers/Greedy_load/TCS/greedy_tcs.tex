...
\documentclass[pdflatex,sn-default,iicol]{sn-jnl}% Basic Springer Nature Reference Style/Chemistry Reference Style
...
\toprule
 Large messages  \\
\midrule
Algorithm & Theoretical Bound\footnotemark[1]   & Experimental performance\footnotemark[2] & Complexity\\
\midrule

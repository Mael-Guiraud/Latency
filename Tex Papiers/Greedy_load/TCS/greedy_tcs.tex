...
\section{Introduction}
 The current Radio Access Networks (RAN) architecture is composed of base stations (called ENode B) managing radio emissions and multiple computations for the purpose of providing service and communicate with core Networks (backhaul)~\cite{bouguen2012lte}. One of the key objective of 5G and beyond is consists in separating enode B into two parts: The Remote Radio Head (RRH), which ensures the radio emissions and the BaseBand Unit (BBU\footnote{Others terminologies exist in the literature. The results of this work are fully compatible with any variation of the C-RAN architecture.}) in charge of the computations.

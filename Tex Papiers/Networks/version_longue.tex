...
\end{figure} 
    ...
    Figure~\ref{fig:datagramtimeline} represents the lifetime  of a datagram  sent on a route $r$ decayed by each arc lenght or buffering time.
  		\begin{figure}
  		 \begin{center}
      \includegraphics[width=\textwidth]{time.pdf}
      \end{center}
      \caption{Timeline of a datagram during its travel on a route $r$}
...
PB: Sur ce genre de figure, on peut pas avoir d'ensemble B car sinon il y a une route qui n'a pas de sommet dans B}
...
\section{Periodic Assignments vs Statistical Multiplexing}\label{sec:comparison}
    ...
    Nevertheless, we propose an adaptation of \ASPMLS that smooth the latency of C-RAN traffic in order to frequently leave some ressource for best effort traffic.

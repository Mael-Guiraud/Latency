...
\end{figure}
	...
	\subsection{Periodic Assignment for Low Latency}
      ...
      \noindent {\bf Question:} Find a valid $(P,\tau)$-periodic assignment which minimizes $TR(A)$
      \bigskip
      ...
      We define the \textbf{margin} of a route $r$ in a routed network $N$, with a deadline function $d$ as $ d(r) - \lambda(r)$. The margin is a bound on the waiting time of a route in a valid assignment.

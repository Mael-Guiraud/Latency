...
The space given by \SASPMLS is illustrated in Figure~\ref{fig:space}
   ...
   We now investigate the size of the free tics gaps created by \SASPMLS. Remember that, in experiment of Figure~\ref{fig:belatency}, we increase the size $\tau'$ of the message untill \ASPMLS does not find an assignment. Considering an instance $I$, we define $L(I,m)$ the function that give the longest size $\tau'$ for which \ASPMLS finds an assignment with margin $m$. Remember that the C-RAN load is low enough to find assignments with $0$ margin. Figure~\ref{fig:space} show the cumulative distribution of $L$ $10,000$ instances .
    ...
    \begin{figure}
      ...
      \end{center}
      \caption{Cumulative distribution of $L$ . The maximal size of $\tau'$ is $P/n=4166$}
      \label{fig:belatency}   
     \end{figure}    

...
\hline
Bandwidth of links &  $10$~Gbps & $\simeq 420$ tics/km\\
\hline
Datagrams size &  $1$~Mbit & $2500$ tics\\
\hline
Number of routes & $8$ & -\\
\hline
\end{tabular}
...
\begin{minipage}{0.48\linewidth}   
      ...
      \includegraphics[width = \linewidth]{departs_distrib2Grp.pdf}
         ...
         \end{center}
      \end{minipage}\hfill
         \caption{Success rate of \PMLS, with length of arcs drawn either in $[I]$ (left) or in $[I]$ or $[P/2,P/2 + I[$ (right).}
      \label{fig:2grp} 
  \end{figure}

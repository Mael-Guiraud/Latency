...
\section{The Star Routed Network} \label{sec:star_routed_network}
   ...
   \todo{   Donner le routed network correspondant. Donner une représentation canonique du routed network -> besoin d'un poids et de deadline. Expliquer qu'on considère le temps de calcul 0}
 ...
 Expliquer l'attente dans les BBUs et le temps de calcul de la réponse.

...
%     In fact, it appears that the FPT-MLS algorithm have, most of the time, the same success rate than the PMLS algorithm, even with a load of $100\%$ and a margin of $0$ (only $2$ instances of $100,000$ have been found by FPT-PMLS and not by PMLS). Since the improvement of FPT-PMLS is insignificant beside the PMLS performances, we investigate the computation time of the two algorithms.

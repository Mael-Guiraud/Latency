...
A routed network : set of routes.
 \end{frame}
...
\vspace{0.5cm}
 ...
 \textcolor{red}{Peridicity must be taken into consideration} 
\end{frame}
...
First step : we first arbitrary fix the offset of the routes.
\vspace{0.5cm}

Second step : algorithms to schedule routes:
\vspace{0.5cm}
\begin{itemize}

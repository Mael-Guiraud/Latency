...
replot   file  using 4:(1.)  smooth cnorm with points title "Statistical multiplexing - Critical deadline" 
replot   file  using 6:(1.) smooth cnorm with points title "Deterministic networking" 

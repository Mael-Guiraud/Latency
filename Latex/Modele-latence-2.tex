...
\todo{Ici on peut mettre un exemple qui montre qu'on peut trouver certaines solutions avec des waitings times
qui donnent des plus petites fenêtres. On peut utiliser l'exemple décrit en rajoutant un très long chemin de manière à ce que les 
...
\todo{Éventuellement donner un nom au problème et au two way trip avec temps d'attente 0. DOnner des notations simples pour les paramètres: $o_i$ offsets, $a_i$ temps de trajet aller retour après le lien central ...}
\todo{Dire que les cas 2 et 3 sont équivalents pour ce problème}
\todo{Insérer le premier algo avec ordre du plus court au plus long. Mieux expliquer le résultat qui me semble pas bon
tel qu'il est écrit}
...
\todo{schéma, car c'est pas très clair comme ca}\\
